		...
		public function __construct() {
			...
			if ( ! is_admin() ) {
				...
				if ( true === astra_addon_builder_helper()->is_header_footer_builder_active ) {
					...
					require_once ASTRA_EXT_STICKY_HEADER_DIR . 'classes/dynamic-css/language-switcher-dynamic.css.php';
					...
					require_once ASTRA_EXT_STICKY_HEADER_DIR . 'classes/dynamic-css/toggle-dynamic.css.php';
				}
			}
		}
	}
