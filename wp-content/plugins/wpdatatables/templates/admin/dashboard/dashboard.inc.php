                ...
                <div class="card wdt-changelog-card">
                    ...
                    <div class="card-body card-padding">
                        ...
                        <div class="alert alert-info m-b-0" role="alert">
                            ...
                            <ul>
                                <li><strong>Feature:</strong> Added integration with Avada Website builder. Read more on this link <a href="https://wpdatatables.com/documentation/general/avada-builder-integration/" target="_blank">Avada Page builder integration for wpDataTables</a>.</li>
                                <li><strong>Feature:</strong> Added integration with DIVI Website builder. Read more on this link <a href="https://wpdatatables.com/documentation/general/divi-builder-integration/" target="_blank">DIVI Website builder integration for wpDataTables</a>.</li>
                ...
                <div class="card wdt-premium-features-card">
                    ...
                    <div class="card-body card-padding">
                        ...
                        <div class="wdt-premium-features">
                            ...
                            <p class="wpdt-font">
                                <i class="wpdt-icon-check m-r-8"></i><span style="color: red;font-weight: bold;">NEW! </span><?php _e('Creating charts with ApexCharts', 'wpdatatables'); ?>
                            </p>
                            <p class="wpdt-font">
                                <i class="wpdt-icon-check m-r-8"></i><?php _e('Creating charts with Highcharts', 'wpdatatables'); ?>
                            </p>
                            <p class="wpdt-font">
                                <i class="wpdt-icon-check m-r-8"></i><?php _e('Export Highcharts data to CSV and XLS files', 'wpdatatables'); ?>
                            </p>
                            <p class="wpdt-font">
