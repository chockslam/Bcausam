...
class Astra_Ext_Footer_Button_Component_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-ext-footer-button-customizer-preview-js', ASTRA_EXT_FOOTER_BUTTON_URI . '/assets/js/' . $dir_name . '/customizer-preview' . $file_prefix . '.js', array( 'customize-preview', 'ahfb-addon-base-customizer-preview' ), ASTRA_EXT_VER, true );
